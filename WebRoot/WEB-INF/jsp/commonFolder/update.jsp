		...
		<fieldset>
			<div class="row">
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.CommonFolder.folderName"></spring:message>： 
				...
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.CommonFolder.storePath"></spring:message>：
