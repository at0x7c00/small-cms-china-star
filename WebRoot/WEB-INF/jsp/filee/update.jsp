...
<div class="pageContent">
	<form:form method="post" action="filee/update.do"
		...
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				<label><spring:message code="props.me.huqiao.smallcms.sys.entity.Filee.name"/>：</label>
			...
			<p>
				<label><spring:message code="props.me.huqiao.smallcms.sys.entity.Filee.extensionName"></spring:message>：</label>
				<form:input path="extensionName" id="filee.extensionName"
					class="textInput" maxlength="20" />
			</p>
			<p>
				<label><spring:message code="props.me.huqiao.smallcms.sys.entity.Filee.createDate"></spring:message>：</label><input name="createDate" id="filee.createDate"
			...
			<p>
				<label><spring:message code="props.me.huqiao.smallcms.sys.entity.Filee.folder"/>：</label>
