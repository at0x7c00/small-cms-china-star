		...
		<article class="col-sm-12 col-md-12 col-lg-12">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form:form action="functionPoint/add.do" cssClass="smart-form" commandName="functionPoint" onsubmit="return validateCallback(this, ${targetPanel eq 'dialog' ? 'dialog' :'navTab' }AjaxDone);">
							...
							<fieldset>
								<div class="row">
									...
									<section class="col col-3">
										<label class="input">
											<spring:message code="props.me.huqiao.smallcms.sys.entity.FunctionPoint.name"></spring:message>： 
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.me.huqiao.smallcms.sys.entity.FunctionPoint.icon"/>:
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.me.huqiao.smallcms.sys.entity.FunctionPoint.isDisplay"/>:
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.me.huqiao.smallcms.sys.entity.FunctionPoint.parent"/>：
