							...
							<fieldset>
								<div class="row">
									...
									<section class="col col-2">
										<label class="input"> <form:input path="content" id="notice.content" size="12" placeholder="${nfn:i18nMessage(reqCtx,'props.me.huqiao.smallcms.notice.entity.Notice.content')}" />
										</label>
									</section>
									<section class="col col-2">
										<label class="input"> <label class="select"> <form:select id="level" path="level" cssClass="comboxed">
													<option value="">-${nfn:i18nMessage(reqCtx,'props.me.huqiao.smallcms.notice.entity.Notice.level')}-</option>
									...
									<section class="col col-2">
										<label class="input"> <form:input path="title" id="notice.title" cssClass="textInput" maxlength="255" size="12" placeholder="${nfn:i18nMessage(reqCtx,'props.me.huqiao.smallcms.notice.entity.Notice.title')}" />
										</label>
									</section>
									<section class="col col-2">
										<label class="input"> <i class="icon-append fa fa-calendar"></i> <input name="createTimeStart" id="notice.createTime" onclick="WdatePicker({dateFmt:'${applicationScope.EN_YEAR_MONTH_DAY_HOUR_MIN_SEC}'});" value="<fmt:formatDate pattern='${applicationScope.EN_YEAR_MONTH_DAY_HOUR_MIN_SEC}' value='${notice.createTimeStart}'/>" class="date_not_required textInput valid" size="12"
											placeholder="${nfn:i18nMessage(reqCtx,'props.me.huqiao.smallcms.notice.entity.Notice.createTime')}(${nfn:i18nMessage(reqCtx,'base.common.form.start')})" />
										</label>
									</section>
									<section class="col col-2">
										<label class="input"> <i class="icon-append fa fa-calendar"></i> <input name="createTimeEnd" id="notice.createTime" onclick="WdatePicker({dateFmt:'${applicationScope.EN_YEAR_MONTH_DAY_HOUR_MIN_SEC}'});" value="<fmt:formatDate pattern='${applicationScope.EN_YEAR_MONTH_DAY_HOUR_MIN_SEC}' value='${notice.createTimeEnd}'/>" class="date_not_required textInput valid" size="12"
											placeholder="${nfn:i18nMessage(reqCtx,'props.me.huqiao.smallcms.notice.entity.Notice.createTime')}(${nfn:i18nMessage(reqCtx,'base.common.form.end')})" />
										</label>
									</section>
									<section class="col col-2">
										<label class="input"> <form:input path="creatorQuery" id="notice.creatorQuery" type="text" cssClass="textInput" size="12" placeholder="${nfn:i18nMessage(reqCtx,'props.me.huqiao.smallcms.notice.entity.Notice.creator')}" />
										</label>
									</section>
								...
								<table id="dt_basic" class="table table-striped table-bordered table-hover" style="border:1px solid red;">
									<thead>
										<tr>
										 ...
										 --%>
											<th align="center" data-sortfield="title" class="${nfn:sortClass(pageBean,'title')}" style="width:50%"><spring:message code="props.me.huqiao.smallcms.notice.entity.Notice.title" /></th>
											<th align="center" data-sortfield="level" class="${nfn:sortClass(pageBean,'level')}"><spring:message code="props.me.huqiao.smallcms.notice.entity.Notice.level" /></th>
											<th align="center" data-sortfield="createTime" class="${nfn:sortClass(pageBean,'createTime')}"><spring:message code="props.me.huqiao.smallcms.notice.entity.Notice.createTime" /></th>
											<th align="center" data-sortfield="creator" class="${nfn:sortClass(pageBean,'creator')}"><spring:message code="props.me.huqiao.smallcms.notice.entity.Notice.creator" /></th>
