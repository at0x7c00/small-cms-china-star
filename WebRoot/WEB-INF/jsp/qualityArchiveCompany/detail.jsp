...
<section id="widget-grid" class="">
	<div class="row">
		<article class="col-sm-12 col-md-12 col-lg-12">
			<form:form method="post" action="qualityArchiveCompany/update.do"
					   class="smart-form required-validate" commandName="qualityArchiveCompany"
				...
				<input type="hidden" name="manageKey" value="qualityArchiveCompany.manageKey"/>
				<ul id="myTab1" class="nav nav-tabs bordered">
					<li class="active"><a href="#baseProperties" data-toggle="tab"><spring:message code="base.common.form.props"/></a></li>
					<%@include file="/WEB-INF/jsp/qualityArchiveCompany/form-tab-title.jsp" %>
				</ul>
				<div id="myTabContent1" class="tab-content">
					<div class="tab-pane fade in active" id="baseProperties">	
						<fieldset>
							<div class="row">
								<%@include file="/WEB-INF/jsp/qualityArchiveCompany/detail-form.jsp" %>
							</div>
						</fieldset>
					</div>
					<%@include file="/WEB-INF/jsp/qualityArchiveCompany/detail-x2many-form.jsp" %>
				</div>
