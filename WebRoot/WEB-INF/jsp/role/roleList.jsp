	...
	<form:form onsubmit="return navTabSearch(this);" action="role/roleListUI" method="post" commandName="role">
		<div class="searchBar">
			<ul class="searchContent">
				<li>
					<label><spring:message code="props.me.huqiao.smallcms.sys.entity.Role.name"/>：</label>
	...
	<table class="table" width="100%" layoutH="138">
		<thead>
			<tr>
				...
				<th width="80" align="center"><spring:message code="props.me.huqiao.smallcms.sys.entity.Role.name"/></th>
				<th align="center"><spring:message code="props.me.huqiao.smallcms.sys.entity.Role.functionPoint"/></th>
			</tr>
		</thead>
		<tbody>
