		...
		<article class="col-sm-12 col-md-12 col-lg-12">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<form:form action="role/update.do" cssClass="smart-form" commandName="role" onsubmit="return validateCallback(this, ${targetPanel eq 'dialog' ? 'dialog' :'navTab' }AjaxDone);">
							...
							<fieldset>
								<div class="row">
									<section class="col col-6">
										<label class="input">
											<spring:message code="props.me.huqiao.smallcms.sys.entity.Role.name"/>：<font color="red">*</font>
								...
								<div class="row">
									<section class="col col-12" style="width:100%;">
										<label class="input">
										<spring:message code="props.me.huqiao.smallcms.sys.entity.Role.description"/>:
