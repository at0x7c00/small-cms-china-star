	...
	<form:form method="post" action="user/update.do"
		...
		<fieldset>
			<div class="row">
				...
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.chineseName"></spring:message>：
						${user.chineseName }
					</label>
				</section>
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.email"></spring:message>：
						${user.email }
					</label>
				</section>
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.phone"></spring:message>：
						${user.phone }
					</label>
				</section>
				...
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.status"></spring:message>：
