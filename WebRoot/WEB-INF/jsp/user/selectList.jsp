	...
	<div class="pageHeader">
		<div class="searchBar" style="height:75px">
			<ul class="searchContent">
				<li>
					<label><spring:message code="props.me.huqiao.smallcms.sys.entity.User.username"></spring:message>：</label>
					<form:input path="userNameQuery" id="user.username" class="textInput" size="12"/>
				</li>
				<li>
					<label>
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.company"></spring:message>：
					</label>
			...
			<thead>
				<tr>
					...
					<th orderField="email"
						...
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.email"/>
					</th>
