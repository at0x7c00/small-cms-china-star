						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" style="border:1px solid red;">
							<thead>
								<tr>
									...
									<th width="30%">
									<spring:message code="props.me.huqiao.smallcms.sys.entity.Role.name"></spring:message>
									
									</th>
									<th>
									<spring:message code="props.me.huqiao.smallcms.sys.entity.Role.description"></spring:message>
