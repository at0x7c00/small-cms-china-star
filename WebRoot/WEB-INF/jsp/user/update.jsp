		...
		<fieldset>
			<div class="row">
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.username"></spring:message>： 
				...
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.chineseName"></spring:message>：<font color="red">*</font>
				...
				<section class="col col-3">
					<label class="input"
						...
						<spring:message
							code="props.me.huqiao.smallcms.sys.entity.User.email"></spring:message>：<font color="red">*</font>
				...
				<section class="col col-3">
					<label class="input"
						style="font:13px/16px 'Open Sans', Helvetica, Arial, sans-serif;">
						<spring:message
							code="props.me.huqiao.smallcms.sys.entity.User.phone"></spring:message>：<font color="red">*</font>
						<form:input path="phone" id="phone"
							class="textInput required phone" maxlength="25" /> </label>
				</section>
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.me.huqiao.smallcms.sys.entity.User.dept"/>：
										<label class="select">
				...
				<section class="col col-3">
				<label><spring:message code="props.me.huqiao.smallcms.sys.entity.User.status"></spring:message>：</label>
					<label class="select">
