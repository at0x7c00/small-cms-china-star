...
<%@include file="/WEB-INF/jsp/common/taglib.jsp"%>
					<div class="widget-body no-padding" style="border:1px solid #e5e5e5;">
						<form:form action="worker/history.do" class="smart-form smart-form-search" onsubmit="return ajaxSearch(this,'${targetPanel}')" commandName="rack">
							...
							<tr>
								...
								<%@include file="/WEB-INF/jsp/worker/history-list-head.jsp" %>
									...
									<tr target="sid_server" rel="${historyRecord.revisionEntity.id}">
										...
										<td>
											<n:pv url="worker/history.do">
												<a href="worker/history.do?version=${historyRecord.revisionEntity.id}&view=yes" rel="manageKeys" target="jquiDialogTodo" title="<spring:message code="base.function.view"></spring:message><spring:message code="base.function.history"/>" width="760" height="400"> <spring:message code="base.function.view"/></a>
											</n:pv>
										</td>
									</tr>
								</c:forEach>
