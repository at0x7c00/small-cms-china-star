package me.huqiao.smallcms.expandimp;
...
import me.huqiao.smallcms.datamodel.PropUtil;
...
public class PropParser {
	...
	public static void main(String[] args) {
		...
		for(ModelProp prop : parser.parseProp("me.huqiao.smallcms.expandimp.Teacher")){
