...
public class VerifyImageServlet extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse resp)
		...
		req.getSession(true).setAttribute(VerifyImageServlet.SIMPLE_CAPCHA_SESSION_KEY, test);// 将字符串写入session
		OutputStream outputStream = null;
		try {
		    outputStream = resp.getOutputStream();
            JPEGImageEncoder encoder = JPEGCodec.createJPEGEncoder(outputStream);// 得到输出流
