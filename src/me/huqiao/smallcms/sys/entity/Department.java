package me.huqiao.smallcms.sys.entity;
...
import me.huqiao.smallcms.taglib.treeselect.ZTreeNode;
...
public class Department implements ZTreeNode {
	 ...
	 */
	@ManyToOne(targetEntity = me.huqiao.smallcms.sys.entity.Department.class, fetch = FetchType.LAZY)
